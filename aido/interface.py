...
class AIDOBaseUserInterface(_AIDOBaseUserInterface):
    ...
    def reconstruct(self, reco_input_path: str, reco_output_path: str) -> None:
        ...
        Args:
            ...
            reco_output_path (str): Path of the output file generated by your reconstruction process. Since
                ...
                following.
            resultd_dir (str, Optional): Allows the user to access the current working directory of the
            reconstruction Task if they want to save extra files manually (e.g. the state dicts of a
            ML model).
